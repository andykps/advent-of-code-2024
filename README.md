...
ANOTHER EDIT: It worked eventually. I played around with the explicit routes for buttons that needed to avoid the non-button until I got the correct result. It seemed to help to only override specific routes, i.e. with specified start _AND_ endpoint.
